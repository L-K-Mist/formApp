                ...
                <v-card>
                    ...
                    <v-card-text>
                        <v-flex xs12>
                            ...
                            <h4>Mentor Visits [no actual data yet]</h4>
                            <p>45 mentor visits were conducted in July 2018 to 32 Growers.  Most mentor visits were conducted to capture crops in the ground (General Mentorship), to deliver seedlings, or collect produce/seed for sale.  </p>
                        </v-flex>                              
                    </v-card-text>
                </v-card>             
            </v-flex>
